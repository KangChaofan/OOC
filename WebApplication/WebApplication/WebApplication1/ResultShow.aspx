<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultShow.aspx.cs" Inherits="WebApplication1.ResultShow" %>
...
<script type="text/javascript">
    ...
    function getStyle(n) {
        // $(".subNav>div:a")
        //$(".subNav").find("a").toggleClass("this");
        $(this).toggleClass("this");
    }
</script>
</head>
...
<iframe id="contentiframe" src="ResultShow_Content.aspx" width="100%" height="900px"></iframe>
</div>
<!-- Content ends -->               
</body>
</html>
