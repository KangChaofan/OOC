<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParamChuShiTiaoJian.aspx.cs"
    Inherits="WebApplication1.ParamChuShiTiaoJian" %>
...
<script src="Scripts/jquery-1.8.0.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //获取sessionStart
            $.ajax({
                url: 'ForSession.aspx?ContentName=ChuShiTiaoJian3',
                type: 'POST',
                dataType: 'html',
                timeout: 10000,
                error: function () {
            ...
            $("#tijiaobtn").click(function () {
                if ($("#tijiaoInfo").html() != "已提交！") {
                    ...
                    $.ajax({
                        url: 'ForSession.aspx?ContentName=ChuShiTiaoJian3&Value=' + uploadifyNote,
                        type: 'POST',
                        data: { Name: "keyun" },
                        dataType: 'html',
                        timeout: 10000,
            ...
            $("#uploadify").uploadify({
                ...
                'uploader': 'WebForm1.aspx?Method=chushitiaojian&ModelID=' + ModelIDParam,
                'folder': 'UploadFile',
                'width': '120',
                'buttonText': '选择文件',
                'debug': false,
